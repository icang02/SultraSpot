<section class="py-0">
  <div class="bg-holder d-none d-md-block"
    style="background-image:url({{ url('frontend') }}/assets/img/illustrations/hero.png);background-position:right bottom;background-size:contain;">
  </div>
  <!--/.bg-holder-->
  ...
  <div class="container position-relative">
    <div class="row align-items-center min-vh-75 my-lg-8">
      <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
        ...
        @guest
          <a class="btn btn-lg btn-primary hover-top" href="{{ url('register') }}" role="button">Sign Up Now</a>
        @endguest

        @auth
          <a class="btn btn-lg btn-primary hover-top" href="#places">Get Started</a>
        @endauth
      </div>
    </div>
  </div>
