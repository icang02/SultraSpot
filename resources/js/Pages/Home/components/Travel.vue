                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white">
                        <a class="stretched-link" href="!#"
                          ><img
                            class="img-fluid"
                            :src="`${base}/frontend/assets/img/gallery/food.png`"
                            alt=""
                        /></a>
                        <div
                          class="
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white">
                        <a class="stretched-link" href="!#"
                          ><img
                            class="img-fluid"
                            :src="`${base}/frontend/assets/img/gallery/backpacking.png`"
                            alt=""
                        /></a>
                        <div
                          class="
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white">
                        <a class="stretched-link" href="!#"
                          ><img
                            class="img-fluid"
                            :src="`${base}/frontend/assets/img/gallery/beaches.png`"
                            alt=""
                        /></a>
                        <div
                          class="
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white">
                        <a class="stretched-link" href="!#"
                          ><img
                            class="img-fluid"
                            :src="`${base}/frontend/assets/img/gallery/art-culture.png`"
                            alt=""
                        /></a>
                        <div
                          class="
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white">
                        <a class="stretched-link" href="!#"
                          ><img
                            class="img-fluid"
                            :src="`${base}/frontend/assets/img/gallery/wild.png`"
                            alt=""
                        /></a>
                        <div
                          class="
                    ...
                    <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                      <div class="card h-100 w-100 text-white">
                        <a class="stretched-link" href="!#"
                          ><img
                            class="img-fluid"
                            :src="`${base}/frontend/assets/img/gallery/hill.png`"
                            alt=""
                        /></a>
                        <div
                          class="
