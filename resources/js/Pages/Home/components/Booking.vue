<template>
  <section id="booking">
    <div
      class="bg-holder"
      :style="`background-image:url(${base}/frontend/assets/img//gallery/booking.png);background-position:center;background-size:cover;`"
    ></div>
    <!--/.bg-holder-->
      ...
      <div class="row">
        <div class="col-12 py-8 text-white">
          <div class="d-flex flex-column flex-center">
            ...
            <h1 class="text-white fs-2 fs-sm-4 fs-lg-7 fw-bold">
