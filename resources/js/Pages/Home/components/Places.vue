                ...
                <div class="row h-100">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top">
                      <img
                        ...
                        :src="`${base}/frontend/assets/img/gallery/maldives.png`"
                        alt=""
                      />
                      <div
                        class="
                      ...
                      >
                        <div class="pt-3">
                          <span class="badge bg-primary">$860</span>
                        </div>
                        <div
                          class="
                            ps-3
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top">
                      <img
                        class="img-fluid h-100"
                        :src="`${base}/frontend/assets/img/gallery/indonesia.png`"
                        alt=""
                      />
                      <div
                        class="
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top">
                      <img
                        class="img-fluid h-100"
                        :src="`${base}/frontend/assets/img/gallery/kathmandu.png`"
                        alt=""
                      />
                      <div
                        class="
                      ...
                      >
                        <div class="pt-3">
                          <span class="badge bg-primary">$340</span>
                        </div>
                        <div
                          class="
                            ps-3
                ...
                <div class="row h-100">
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top">
                      ...
                      >
                        <div class="pt-3">
                          <span class="badge bg-primary">$540</span>
                        </div>
                        <div
                          class="
                            ps-3
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top">
                      ...
                      >
                        <div class="pt-3">
                          <span class="badge bg-primary">$640</span>
                        </div>
                        <div
                          class="
                            ps-3
                ...
                <div class="row h-100">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 text-white hover-top">
                      <img
                        class="img-fluid h-100"
                        :src="`${base}/frontend/img/gallery/kathmandu.png`"
                        alt=""
                      />
                      <div
                        class="
