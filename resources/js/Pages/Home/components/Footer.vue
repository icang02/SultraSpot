      ...
      <div class="row flex-center">
        <div class="col-auto mb-4">
          <ul class="list-unstyled list-inline mb-0">
            ...
            <li class="list-inline-item me3 me-sm-4">
              <a class="text-dark text-decoration-none" href="#!">Video</a>
            </li>
            <li class="list-inline-item me3 me-sm-4">
            ...
            <li class="list-inline-item me3 me-sm-4">
              <a class="text-dark text-decoration-none" href="#!">Booking</a>
            </li>
            <li class="list-inline-item me3 me-sm-4">
              <a class="text-dark text-decoration-none" href="#!">Contact</a>
            </li>
            <li class="list-inline-item me3 me-sm-4">
              <a class="text-dark text-decoration-none" href="#!">Pricing</a>
            </li>
            <li class="list-inline-item me3 me-sm-4">
              <a class="text-dark text-decoration-none" href="#!"
                >Privacy Policy</a
