            ...
            <div class="row align-items-center">
                  ...
                  <div class="row h-100 w-100">
                    <div class="col-12 px-1">
                      ...
                      >
                        <img
                          class="d-block"
                          :src="`${base}/frontend/assets/img/gallery/maldives-v.png`"
                          alt="Videos 1"
                        />
                      </button>
                    </div>
                    <div class="col-12 px-1">
                      ...
                      >
                        <img
                          class="d-block"
                          :src="`${base}/frontend/assets/img/gallery/tanzania.png`"
                          alt="Videos 2"
                        />
                      </button>
                    </div>
                    <div class="col-12 px-1">
                      ...
                      >
                        <img
                          class="d-block"
                          :src="`${base}/frontend/assets/img/gallery/kathmandu-v.png`"
                          alt="Videos 3"
                        />
                      </button>
                    </div>
                    <div class="col-12 px-1">
                      ...
                      >
                        <img
                          class="d-block"
                          :src="`${base}/frontend/assets/img/gallery/chaina.png`"
                          alt="Videos 4"
                        />
                      </button>
                    </div>
              ...
              <div class="col-6 col-lg-3 px-xxl-0">
                <div class="row">
                  <div
                    class="
                      col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7
                      px-xxl-0
                      ps-lg-0 ps-md-4
                    "
                  >
                    <div
                      class="card h-100 py-md-2 active"
                    ...
                    >
                      <div
                        ...
                        "
                      >
                        <p class="mb-0 fw-semi-bold text-dark">
                          When go to maldives
                        </p>
                        <p class="card-text">
                          <small class="text-800">0.20</small>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="card h-100 py-md-2" style="min-height: 113px">
                      <div
                        ...
                        "
                      >
                        <p class="mb-0 fw-semi-bold text-500">
                          Tanzania’s deadly pink lake
                        </p>
                        <p class="card-text">
                          <small class="text-800">05.24</small>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="card h-100 py-md-2" style="min-height: 113px">
                      ...
                      >
                        ...
                        <p class="card-text">
                          <small class="text-800">06.12</small>
                        </p>
                      </div>
                    </div>
                  </div>
